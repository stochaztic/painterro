...
|`hiddenTools` | List of tools that you wish to exclude from toolbar e.g. something from this list `['crop', 'line', 'arrow', 'rect', 'ellipse', 'brush', 'emoji', 'rotate', 'resize',  'save', 'open', 'close']`, You can't hide default tool | [] |
